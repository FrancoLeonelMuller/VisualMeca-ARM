Public Class Manual
    ...
    Function MandarPaquete(ByVal IpRobot As String, ByVal Mensaje As String) As Integer
        ...
        Catch e As System.Net.WebException
            MsgBox("A ocurrido un error al enviar el movimiento, compruebe conexion con el Robot")
        End Try
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If EstadoRobot = True Then
            BtnSend.Enabled = True
            btnPosOrigen.Enabled = True
        Else
            BtnSend.Enabled = False
            btnPosOrigen.Enabled = False
        End If
    End Sub
    ...
    Private Sub BtnConnectRobot_Click(sender As Object, e As EventArgs) Handles BtnConnectRobot.Click
        Dim PaqueteRobotConexion As String
        IpRobot = TextBox_IpRobot.Text
        PaqueteRobotConexion = "http://" + IpRobot + "/conectar"


        If My.Computer.Network.Ping(IpRobot, 500) Then
            Dim webClient As New System.Net.WebClient
            Try
                Dim result As String = webClient.DownloadString(PaqueteRobotConexion)
                EstadoRobot = True
                EstadoPingRobot.Image = My.Resources.ConectadoRobot
                TextBoxRobotConectado.Text = "Robot Conectado"
            Catch errorConexion As System.Net.WebException
                EstadoRobot = False
                EstadoPingRobot.Image = My.Resources.ErrorPing
                TextBoxRobotConectado.Text = "Robot Desconectado"
                MsgBox("Se encontro un dispositivo con esa IP pero no pertenece al Robot")
            End Try
        Else
            MsgBox("No se encontro ningun dispositivo con esa IP")
            EstadoRobot = False
            EstadoPingRobot.Image = My.Resources.ErrorPing
            TextBoxRobotConectado.Text = "Robot Desconectado"
        End If
    ...
    Private Sub BtnCtrlManual_Home_Click(sender As Object, e As EventArgs) Handles BtnCtrlManual_Home.Click
        TabGeneral.SelectTab(1)
    End Sub
    Private Sub BtnCtrlManual_Secuencias_Click(sender As Object, e As EventArgs) Handles BtnCtrlManual_Secuencias.Click
        TabGeneral.SelectTab(1)
    End Sub

    Private Sub BtnHome_ControlManual_Click(sender As Object, e As EventArgs) Handles BtnHome_ControlManual.Click
        TabGeneral.SelectTab(0)
    End Sub
    Private Sub BtnHome_Secuencias_Click(sender As Object, e As EventArgs) Handles BtnHome_Secuencias.Click
        TabGeneral.SelectTab(0)
    End Sub

    Private Sub BtnSecuencias_Home_Click(sender As Object, e As EventArgs) Handles BtnSecuencias_Home.Click
        TabGeneral.SelectTab(2)
    End Sub
    Private Sub BtnSecuencias_ControlManual_Click(sender As Object, e As EventArgs) Handles BtnSecuencias_ControlManual.Click
        TabGeneral.SelectTab(2)
    End Sub
